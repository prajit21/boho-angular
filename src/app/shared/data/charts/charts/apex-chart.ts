...
import {
  ...
  RadialBarChart,
  StepLineChart,
} from '../../../interface/apex-charts';

let primaryColor = localStorage.getItem('--theme-default') || '#33BFBF';
let secondaryColor = localStorage.getItem('--theme-secondary') || '#ff6150';
...
export const areaSpalineChart: AreaSpalineChart = {
  chart: {
    height: 350,
    type: 'area',
    toolbar: {
...
export const stepLineChart: StepLineChart = {
  chart: {
    type: 'line',
    height: 350,
    toolbar: {
...
export const columnChart2: ColumnChart2 = {
  annotations: {
    yaxis: [
      {
        y: 8200,
...
export const donutChart: DonutChart = {
  ...
  colors: ['#dc3545', '#f8d62b', primaryColor, '#51bb25', '#a927f9'],
};

export const mixChart: MixChart = {
  chart: {
    height: 350,
    type: 'line',
    stacked: false,
  ...
  colors: [secondaryColor, '#51bb25', primaryColor],
};

export const candleStickChart: CandleStickChart = {
  chart: {
    height: 350,
    type: 'candlestick',
    toolbar: {
...
export const radialBarChart: RadialBarChart = {
  ...
  colors: [secondaryColor, '#51bb25', '#f8d62b', primaryColor],
};
