...
let primary_color = localStorage.getItem('--theme-default') || '#33BFBF';
let secondary_color = localStorage.getItem('--theme-secondary') || '#ff6150';
...
export const radarGraphLabels: string[] = ['Ford', 'Chevy', 'Toyota', 'Honda', 'Mazda'];
...
export const lineChartLabels: string[] = ['', '10', '20', '30', '40', '50', '60', '70', '80'];
...
export const doughnutChartLabels: string[] = ['Primary', 'Secondary', 'Success'];
